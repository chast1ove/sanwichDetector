...
web3._extend({
	...
	[
		new web3._extend.Method({
			name: 'currentBlockSandwich',
			call: 'detect_detectCurrentBLockSandwichAttack',
			params: 2,
		}),
		new web3._extend.Method({
			name: 'newBlockSandwich',
			call: 'detect_detectNewBlockSandwichAttack',
			params: 0,
		}),
		new web3._extend.Method({
			name: 'stop',
			call: 'detect_stopDetect',
			params: 0,
		}),
	],
});
